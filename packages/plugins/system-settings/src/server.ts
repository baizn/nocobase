    ...
    await this.db.getRepository('systemSettings').create({
      values: {
        ...
        logo: {
          ...
          extname: '.svg',
          mimetype: 'image/svg',
          url: 'https://mdn.alipayobjects.com/huamei_2dxjn8/afts/img/A*t-vJTKbtM5cAAAAAAAAAAAAADrR-AQ/original', // 'https://mdn.alipayobjects.com/huamei_2dxjn8/afts/img/A*wbScRr0wTBUAAAAAAAAAAAAADrR-AQ/original'
        },
      },
    });
  }
